...
def normal_ai_play(player1_or_player2:int, board:list) -> bool:
    ...
    board, keep_playing, game_is_finished = make_play(player1_or_player2, position, board)
...
def advanced_ai_play(player1_or_player2:int, board:list) -> bool:
    ...
    if full_circle == 1:
        board, keep_playing, game_is_finished = make_play(player1_or_player2, position_to_play, board)
