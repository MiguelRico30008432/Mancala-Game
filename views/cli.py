...
def main() -> None:
    ...
    while True:
        ...
        if valid_awnser == 1:
            ...
            elif user_input[0] == "G" and len(user_input) == 2:
                con.save_game(players, game_status, user_input)

            elif user_input[0] == "L" and len(user_input) == 2:
                players, game_status = con.load_saved_game(user_input)
...
def details_of_game_dj(games_status:list) -> None:
    ...
    if games_status[2] == 1:
        ...
        print("Não existem jogo em curso.")